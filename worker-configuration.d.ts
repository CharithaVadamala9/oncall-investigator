/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f0cfde4fba17f47fe47551c3b66e6261)
// Runtime types generated with workerd@1.20260714.1 2024-11-01 nodejs_compat
interface __BaseEnv_Env {
	KV: KVNamespace;
	oncall_investigator_db: D1Database;
	METRICS: AnalyticsEngineDataset;
	ASSETS: Fetcher;
	CF_ACCOUNT_ID: "e7fe6bdee08b8ce28ec59369013786e3";
	ANTHROPIC_API_KEY: string;
	CF_API_TOKEN: string;
	TRAFFIC_GENERATOR: DurableObjectNamespace<import("./src/index").TrafficGenerator>;
	INVESTIGATOR: DurableObjectNamespace<import("./src/index").Investigator>;
	SUMMARY_AGENT: DurableObjectNamespace<import("./src/index").SummaryAgent>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "TrafficGenerator" | "Investigator" | "SummaryAgent";
	}
